...
return {
  -- Obsidian.nvim: wikilinks [[...]], backlinks, daily notes, templates
  {
    ...
    cmd = {
      'Obsidian', -- meta command (newer versions) – optional
      'ObsidianNew',
    ...
    opts = {
      ...
      workspaces = {
        {
          name = 'personal',
          path = '~/obsd_vaults/personal',
        },
        {
          name = 'etc',
          path = '~/obsd_vaults/etc',
    ...
    keys = {
      ...
      { '<leader>p', '<cmd>ObsidianPasteImg<cr>', desc = 'Notes: Paste image' },
      {
        'gf',
        function()
